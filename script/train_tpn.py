...
for i in range(5):
    ...
    # model.load_state_dict(torch.load(model_saved_path + 'DeepME_fseof_0.pkl',weights_only=True))
    ...
    torch.save(trainer.model.state_dict(), model_saved_path + 'DeepME_{}.pkl'.format(i))
#-----------------------------------------
